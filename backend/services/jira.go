...
const (
	scanStartedTemplate = `A new scan has been initiated in Orbit.
...
This notification was automatically generated by Orbit.
...
For more details, please see {{jira_link}}`
	...
	scanFailedTemplate = `A scan has failed in Orbit.
